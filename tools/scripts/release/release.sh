...
if [[ -z $SKIP_OCKAM_BINARY_RELEASE || $SKIP_OCKAM_BINARY_RELEASE == false ]]; then
  ...
  dialog_info "Draft release has been created, please vet and release then press enter to start homebrew and terraform CI"
...
dialog_info "Terraform draft release has been created, please vet and release then press enter to start Terraform binary release"
